	...
	<tbody id="calendarBody" class="flex flex-col">
        @for($i = 0; $i < 6; $i++)
            <tr class="flex w-full calendarRowData" data-week="{{ $i + 1 }}" dataId="">
                <x-calendar-components.td class="sunday h-[270px]" />
                <x-calendar-components.td class="monday h-[270px]" />
                <x-calendar-components.td class="tuesday h-[270px]" />
                <x-calendar-components.td class="wednesday h-[270px]" />
                <x-calendar-components.td class="thursday h-[270px]" />
                <x-calendar-components.td class="friday h-[270px]" />
                <x-calendar-components.td class="saturday h-[270px]" />
            </tr>
        @endfor
    </tbody>
</table>
