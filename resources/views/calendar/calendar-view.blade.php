    ...
    <div class="2xl:col-span-9 flex flex-col h-full overflow-x-auto"> {{-- overflow-x-auto --}}
        <div class="min-w-[1150px] flex flex-col h-full"> {{-- min-w-[1075px] 1530 1377 --}}
            ...
            <div class="mt-2 flex-1 flex flex-col bg-white overflow-hidden shadow-xs sm:rounded-lg"> {{-- xl:overflow-visible --}}
                ...
                <div id="viewDaily" class="p-6 hidden h-full overflow-x-auto 2xl:min-h-[678px]"> {{-- added: overflow-x-auto remove: min-h-[678px] --}}
                    <div class="grid grid-cols-12 grid-rows-[auto_1fr] gap-0 h-full xl:min-w-[1161px]"> {{-- added xl, it was min-w-[1161px] --}}
                        <div class="col-span-12 grid grid-cols-12 gap-0 h-full">
                            @include('calendar.calendar-parts.daily')
                        </div>
                        <div class="col-span-12 grid grid-cols-12 gap-0 h-full max-xl:hidden">
