    ...
    <x-case-components.grid   class="2xl:grid-cols-12">
        <div class="2xl:col-span-3 flex flex-col ">
            <div >
                ...
                <x-text-input id="referralChiro" name="referralChiro" placeholder="Insert Referral" type="text" class="mt-1  text-center" :value="old('name')"   autofocus autocomplete="referralChiro" />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>

            <div>
                <x-input-label for="chiro" :value="__('Chiro')" />
                <x-text-input id="chiro" name="chiro" placeholder="Insert Chiro" type="text" class="mt-1  text-center" :value="old('name')"   autofocus autocomplete="chiro" />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>
        </div>
        <div class="2xl:col-span-3 flex flex-col ">
            <div>
                ...
                <x-text-input id="doi" name="doi"  placeholder="00/00/00" type="text" class="mt-1  text-center" :value="old('name')"   autofocus autocomplete="doi" />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>
             <div>
                <x-input-label for="preExistingInjuries" :value="__('Pre-Existing Injuries')" />
                <x-text-input id="preExistingInjuries" name="preExistingInjuries"  placeholder="Back Surgery" type="text" class="mt-1   text-center" :value="old('name')"   autofocus autocomplete="preExistingInjuries" />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>
        </div>
        ...
        <div class="2xl:col-span-3 flex flex-col ">
            <div>
                ...
                <x-text-area id="facts" name="facts" placeholder="How it happened" type="text" class="mt-1 h-[77px]  text-center" :value="old('name')"   autofocus autocomplete="facts" />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>
        </div>
        <div class="2xl:col-span-3 flex flex-col ">
            <div>
                ...
                <x-text-area id="injuries" name="injuries" placeholder="Neck & Back" type="text" class="mt-1 h-[77px]  text-center" :value="old('name')"   autofocus autocomplete="injuries" />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>
        </div>
