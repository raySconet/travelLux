<section>
    ...
    <x-case-components.grid  class="2xl:grid-cols-12 mt-2">
        <div class="2xl:col-span-12 flex flex-col ">
            <p class="mb-1  mt-1  text-xl text-gray-700 text-center border border-[#CCC] p-2 bg-[#eaf1ffd4]">
                {{ __("3P") }}
            </p>
            <div class="appendDuplicatesFor3p" >
                <x-case-components.grid class="2xl:grid-cols-14 mt-2" id="clientToDuplicate">
                    ...
                    <x-case-components.col class="2xl:col-span-4">
                        {{-- <x-input-label for="Address" :value="__('Address')" /> --}}
                        <x-text-input  name="threeAddress" type="text" class="mt-1 placeholder:text-yellow-600 text-center"  placeholder="Address" :value="old('name')"  required autofocus autocomplete="threeAddress" />
                        <x-input-error class="mt-2" :messages="$errors->get('name')" />
                    </x-case-components.col>
                    <x-case-components.col class="2xl:col-span-3">
                        {{-- <x-input-label for="Address" :value="__('Address')" /> --}}
        ...
        <div class="2xl:col-span-12 flex flex-col ">
           ...
           <div class="appendDuplicatesFor1p">
                <x-case-components.grid  class="2xl:grid-cols-14" id="clientToDuplicate">
                    ...
                    <x-case-components.col class="2xl:col-span-4">
                        {{-- <x-input-label for="Address" :value="__('Address')" /> --}}
                        <x-text-input  name="onePAddress"  placeholder="Address"  type="text" class="mt-1 placeholder:text-yellow-600 text-center"  :value="old('name')"  required autofocus autocomplete="onePAddress" />
                        <x-input-error class="mt-2" :messages="$errors->get('name')" />
                    </x-case-components.col>
                    <x-case-components.col class="2xl:col-span-3">
                        {{-- <x-input-label for="Address" :value="__('Address')" /> --}}
