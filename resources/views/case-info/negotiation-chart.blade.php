<section class="mt-1">
    ...
    <div class= "grid grid-cols-1 2xl:grid-cols-12 gap-2 w-full " id="negotiationToDuplicate">
        ...
        <x-case-components.col class="2xl:col-span-1  items-center justify-center">
            <div class="flex items-center justify-center w-6 h-6 rounded-full cursor-pointer bg-[#14548d] addButtonForNegotiation" style="margin-top:22px; width:26px; height:26px;">
