<div>
    ...
    <div class="flex flex-col mt-3">
        ...
        <textarea id="special_notes" name="special_notes" rows="1" class="w-full border-b-2 border-[#bdbdbd] focus:outline-none focus:border-[#B6844A] resize-none pt-1 pb-1">
