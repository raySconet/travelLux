        ...
        @php
            ...
            if ($sentForm->submit_flag == 1) {
                if ($sentForm->submitted_on) {
                    ...
                    $submittedText = "<span class='text-[#50c878]'>Customer Submitted on {$submittedOn}</span>";
                } else {
                    $submittedText = "<span class='text-[#50c878]'>Submitted by Customer</span>";
                }
            } else {
                $submittedText = "<span class='text-[#B6844A]'>Not Submitted By Customer</span>";
            }
        @endphp
        ...
        <div class="flex items-center justify-between mt-2">
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-sm text-gray-600"><i class="fas fa-calendar-alt mr-1"></i>Form Sent On {{ $sentOn }}</p>
