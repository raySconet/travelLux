<div class="flex flex-col mt-4">
    ...
    <textarea id="general_notes" name="general_notes" rows="3" class="w-full border-b-2 border-[#bdbdbd] focus:outline-none focus:border-[#B6844A] resize-none pt-1 pb-1">
        {{ old('general_notes', $customer->general_notes ?? '') }}
    </textarea>
</div>
