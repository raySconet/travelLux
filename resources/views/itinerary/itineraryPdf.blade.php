...
<html>
    ...
    <body>
                ...
                @foreach($day->events as $event)
                    ...
                    @php
                        ...
                        if($event->eventTime && $event->eventTime != '-1'){
                            ...
                            $formattedTime = \Carbon\Carbon::parse($event->eventTime)->format('g:i A');
                        }
        ...
        @if($itinerary->attachments->count() > 0)
            ...
            <div class="day-block">
                ...
                <div style="margin-top:15px;">
                    ...
                    @foreach($itinerary->attachments as $attachment)
                        ...
                        @php
                            $fileUrl = route('itinerary.attachments.view', $attachment->id);
                        @endphp

                        <div style="margin-bottom:10px;">

                            <a href="{{ $fileUrl }}" style="margin-left:8px; color:#007bff; text-decoration:underline;">
