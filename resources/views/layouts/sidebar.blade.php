...
<!-- SIDEBAR -->
<div
    class="fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform transition-all duration-600 z-40 border-r border-r-[#292727]"
    ...
    <ul class="space-y-3 text-base text-[#696969]" style="overflow-y: auto; height:91%;">
        ...
        <li x-data="{ open: false }">
            ...
            <div x-show="open" x-cloak class="text-sm mt-2 space-y-2">
                ...
                <a href="/reservationsNotPaidByALTReport" class="block py-1 sidebarA">Reservations Not Paid By Travelux <i class="text-lg fas fa-money-check"></i></a>
                <a href="/reservationsPaidByALTReport" class="block py-1 sidebarA">Reservations Paid By Travelux <i class="text-lg fas fa-money-bill-alt"></i></a>
                @if(auth()->user()->isAdmin())
                    ...
                    <a href="/reservationsChangesReport" class="block py-1 sidebarA">Reservations Changes Report <i class="text-lg fas fa-tag"></i></a>
                    <a href="/reservationsByAgentReport" class="bloack py-1 sidebarA">Reservations By Agent Report <i class="text-lg fas fa-tags"></i></a>
                @endif
                ...
                @if(auth()->user()->isAdmin())
                    ...
                    <a href="/cruisesReport" class="block py-1 sidebarA">Cruises Report<i class="text-lg fas fa-ship"></i></a>
                    ...
                    <a href="/pleasantEvokeReport" class="block py-1 sidebarA">Pleasant/Evoke Report<i class="text-lg fas fa-layer-group"></i></a>
