<x-app-layout>
    <x-slot name="header">
        <div class="p-4 bg-white shadow sm:rounded-none flex items-center justify-between">
            <h2 class=" text-2xl text-gray-500 leading-tight">
                <i class="fa-solid fa-plane-departure mr-2 text-[#f18325]"></i>{{ __('All Trips By Travel Date') }}
            </h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    <thead class="bg-white">
                        <tr>
                            <th class="w-1/3 px-4 py-3 text-left text-sm font-bold border-b-2 border-t-2 border-[#dee2e6]">
                                Reservation Number
                            </th>
                            <th class="w-1/3 px-4 py-3 text-left text-sm font-bold border-b-2 border-t-2 border-[#dee2e6]">
                                Client Name
    ...
    <x-report-range-date>
        <x-slot name="footer">
            <x-primary-btn id="allTripsByTravelDateReport"><i class="fa fa-paper-plane"></i><span>Run Report</span></x-primary-btn>
            <x-secondary-btn onclick="closeReportDateRange()"><i class="fa fa-times-circle"></i><span>Cancel</span></x-secondary-btn>
        </x-slot>
    </x-report-range-date>
</x-app-layout>
