    ...
    <x-slot name="header">
        <div class="py-4 px-4 bg-white shadow sm:rounded-lg flex items-center justify-between">
            <h2 class=" text-xl text-gray-500 leading-tight">
                <i class="fa-solid fa-poll mr-2 text-[#f18325]"></i>{{ __('Product Sales by Agent') }}
            </h2>
...
<x-report-range-date>
    <x-slot name="footer">
        <x-primary-btn id="productSalesByAgentReportBtn"><i class="fa fa-paper-plane"></i><span>Run Report</span></x-primary-btn>
