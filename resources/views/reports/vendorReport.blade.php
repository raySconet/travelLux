<x-app-layout>
    <x-slot name="header">
        <div class="p-4 bg-white shadow sm:rounded-none flex items-center justify-between">
            <h2 class=" text-2xl text-gray-500 leading-tight">
                <i class="fa-solid fa-building mr-2 text-[#f18325]"></i>{{ __('Vendor Sales') }}
            </h2>
    ...
    <x-report-range-date>
        <x-slot name="footer">
            <x-primary-btn id="VendorReportBtn"><i class="fa fa-paper-plane"></i><span>Run Report</span></x-primary-btn>
