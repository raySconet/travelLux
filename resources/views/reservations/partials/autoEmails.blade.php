                ...
                @forelse($autoEmails as $item)
                    <tr class="border-b-1 border-[#dee2e6]">
                        ...
                        <td class="w-1/12 flex mt-3 space-x-6 text-lg mr-4"> 
                            <i class="fas fa-paper-plane text-[#B6844A] cursor-pointer resendReservationAutomatedEmail" data-url="{{ route('reservations.resendAutomatedEmail', [$reservation, $item]) }}"></i>
