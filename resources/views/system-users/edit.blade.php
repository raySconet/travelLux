<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="space-x-2">
                <button class="bg-gray-800 text-white px-4 py-2 rounded"><i class="fas fa-trash"></i><span>Delete</span></button>
                <button class="bg-gray-400 text-white px-4 py-2 rounded"><i class="fas fa-save"></i>Save User</button>
                <x-primary-btn><i class="far fa-minus-square"></i>Close User</x-primary-btn>
            </div>
        </div>
    </x-slot>
