<div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        <div class="relative mt-3">
            ...
            <select name="product" id="product" class="w-full border-b-2 border-[#bdbdbd] mb-4 focus:outline-none focus:border-[#f18325]">
        ...
        <div class="relative mt-3">
            ...
            <select name="destination" id="destination" class="w-full border-b-2 border-[#bdbdbd] mb-4 focus:outline-none focus:border-[#f18325]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
        ...
        <div class="relative mt-5">
            ...
            <select name="timelineTaskBeforeAfter" id="timelineTaskBeforeAfter" class="w-full border-b-2 border-[#bdbdbd] mb-4 focus:outline-none focus:border-[#f18325]">
        ...
        <div class="relative mt-5">
            ...
            <select name="timelineTaskDateType" id="timelineTaskDateType" class="w-full border-b-2 border-[#bdbdbd] mb-4 focus:outline-none focus:border-[#f18325]">
